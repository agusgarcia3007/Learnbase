...
export const env = {
  ...
  CLOUDFLARE_CNAME_TARGET:
    Bun.env.CLOUDFLARE_CNAME_TARGET || "domains.uselearnbase.com",
  ...
  STRIPE_CONNECT_WEBHOOK_SECRET: Bun.env.STRIPE_CONNECT_WEBHOOK_SECRET || "",
  STRIPE_STARTER_PRICE_ID: Bun.env.STRIPE_STARTER_PRICE_ID || "",
  STRIPE_GROWTH_PRICE_ID: Bun.env.STRIPE_GROWTH_PRICE_ID || "",
  STRIPE_SCALE_PRICE_ID: Bun.env.STRIPE_SCALE_PRICE_ID || "",
};
